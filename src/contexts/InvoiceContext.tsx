...
import type { Invoice, Expense, SalaryPayment, ExpenseCategory, Payment } from "@/lib/types";

// Mock data for initial state, used only if localStorage is empty
const mockInvoices: Invoice[] = [
  {
    id: "1",
    invoiceNumber: "INV-20230115-0001",
  ...
  {
    id: "2",
    invoiceNumber: "INV-20230116-0002",
   ...
   {
    id: "3",
    invoiceNumber: "INV-20230117-0003",
  ...
  {
    id: "4",
    invoiceNumber: "INV-20230118-0004",
  ...
  {
    id: "5",
    invoiceNumber: "INV-20230119-0005",
  ...
  {
    id: "6",
    invoiceNumber: "INV-20230120-0006",
...
export const InvoiceProvider = ({ children }: { children: ReactNode }) => {
  ...
  return (
    <InvoiceContext.Provider value={{ invoices, expenses, addInvoice, updateInvoice, getInvoiceById, addExpense, updateExpense, deleteExpense }}>
      {children}
